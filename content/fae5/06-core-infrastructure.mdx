...
chapter_no: 3
image: https://futureartecosystems.org/wp-content/uploads/2025/06/trust-plotting.jpg
background_image: https://futureartecosystems.org/wp-content/uploads/2025/06/bg-trust-plotting.png
next_chapter: 07-innovation
next_chapter_title: Innovation
---

{/* Image: Trust Plotting */}
...
These departmental and spin-out structures benefit from their parent organisations\' accumulated knowledge, public trust, and sectoral influence. Their institutional backing enables them to undertake speculative, longer-term developmental projects that may be prohibitively risky for smaller entities, and helps translate experimental approaches into sector-wide practices. Perhaps most significantly, these structures serve as crucial interfaces between the cultural sector and other domains by developing capacities that allow them to translate between different value systems, methodologies, and goals, enabling them to host cross-sectoral collaborations.
...
{/* Image: 221a Node Library */}

<Picture
  main="https://futureartecosystems.org/wp-content/uploads/2025/06/221aNodeLibraryDiagram.jpg"
  bg="https://futureartecosystems.org/wp-content/uploads/2025/06/bg-221a-node.png"
/>
...
221A in Vancouver represents a particularly distinctive approach, evolving from a traditional artist-run centre into an organisation that operates at the nexus of art, design, and technological infrastructure. Through its Fellowship Programme, 221A supports practitioners developing long-term projects around digital infrastructures, urban politics, and technological governance. Its Pollyanna Library functions not just as a collection of materials but as an 'interface for a community of practice', supporting shared inquiry around technological systems. Most ambitiously, 221A\'s Blockchains & Cultural Padlocks initiative explores how distributed ledger technologies might create new models for cultural property, developing practical prototypes for community-governed digital infrastructure.
...
Creative R&D within AxAT organisations functions as a distinct adaptability engine that enables both individual institutions and the cultural sector at large to navigate technological change through experimental practice. Unlike conventional \'digital transformation\'---which typically focuses on integrating existing technological products and services into organisational operations---Creative R&D generates innovation through exploratory processes that often produce unexpected outcomes and novel approaches.

This distinction between 'digital transformation' and Creative R&D is crucial; where digital transformation might involve implementing a new ticketing system or digitising collections, Creative R&D engages with emerging technologies as materials for experimentation, allowing organisations to develop new capabilities, methodologies, and even missions in response to technological change. Rather than simply adopting tools developed elsewhere, these organisations become active participants in shaping how technologies evolve and how they might serve cultural purposes.
...
These examples illustrate how Creative R&D enables what might be called \'anticipatory adaptation\'---developing capabilities and approaches before they become necessary, rather than reacting to technological change after it has already transformed the landscape. This experimental orientation allows organisations to fail productively, learning from unsuccessful experiments in ways that inform future development. It also positions cultural organisations as sites of technological innovation rather than as mere consumers of it, contributing to broader conversations about how emerging technologies should function in society.
...
>
> <cite>
>   - Tonya Nelson, Executive Director, Enterprise & Innovation, Arts Council
>   England
> </cite>
...
{/* Image: Watershed Project: the apothecary network */}

<Picture
  main="https://futureartecosystems.org/wp-content/uploads/2025/06/apothecary-network.jpg"
  bg="https://futureartecosystems.org/wp-content/uploads/2025/06/bg-apothecary-network.png"
/>
...
An emerging juncture in the Creative R&D ecosystem is where cultural organisations and civic entities converge to develop frameworks for technology that centre public interest concerns. These new types of collaborations leverage complementary capabilities: cultural organisations contribute a platform for interacting with AxAT practices, alongside public engagement expertise, while civic organisations bring policy knowledge, advocacy networks, and alternative governance models.
...
>
> <cite>
>   - Tom Crick, Chief Scientific Adviser, Department for Culture, Media and
>   Sport
> </cite>
...
These educational collaborations create pathways for knowledge and skill development that connect academic learning environments with professional cultural contexts.
...
These shared infrastructures create economies of scale and knowledge pooling that which would be difficult for either cultural or academic institutions to achieve independently.
