...
next_chapter: /briefing/fae5/05-ecosystem
next_chapter_title: Ecosystem
---
...
Models are ambiguous entities that are proving hard to define both
legally and conceptually. There is an inherent tension between the _modus
operandi_ of the law and that of technical developments. Judgements made through civil
...
Nevertheless, incoming legislation, such as the EU AI Act or Blueprint for the AI Bill
of Rights in the US, as well as the work of dedicated public AI-oriented
organisations, sets some of the apex terms of the negotiation between the tech
sector and the public.[^26] Given that we are still in the stage where foundation
...
personhood) as well as the credentials of the media around us.[^33] The
