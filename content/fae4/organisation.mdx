...
title: Organisation
chapter_no: 1
video: https://futureartecosystems.org/wp-content/uploads/2024/03/crosslucid-fae4-chapter1.mp4
video_mobile: https://futureartecosystems.org/wp-content/uploads/2024/03/CROSSLUCID_CH01_ORG_HD.mp4
video_credit: "Line of flight: Organization © Crosslucid 2024"
---

<Box>
The concept of ‘organisation’ both refers to an entity - _an_ organisation - acting in pursuit of a set of goals, but the term also refers to the process of organising. Every new technical advancement in information-gathering, processing and circulation has created affordances and challenges for how organisation is structured as a process, and what it enables; think of the telegraph, the printing press, the digital computer, or the internet. That the dominant form of organisation today is achieved through techno-social units that persist across geographies and generations is in large part owed to the aforementioned technologies. The confrontation of the AI stack with the _du jour_ systems of organisation has the capacity to inaugurate a new chapter in how organisations function, how they are structured, their daily operations and their mandates, as well as in the more fundamental sense of what kinds of societies they enable.
...
Trust and verifiability protocols that are technically integrated across the AI stack will become a necessity as our interactions with opaque systems increase. Not only will users want to know if model outputs can be trusted, there will also be a need to verify our own identities (i.e. proof of personhood) as well as the credentials of the media around us.[^33] The development of capabilities to track provenance and attribution by bridging blockchain infrastructure with running of models is a new frontier that promises major advances in the years to come.[^34]
...
[^6]:
    ...
    See Seth Lazar, _Frontier AI Ethics_ (2022) [[link](https://aeon.co/essays/can-philosophy-help-us-get-a-grip-on-the-consequences-of-ai)].
...
[^9]: Seth Lazar, _Frontier AI Ethics_ (2022) [[link](https://aeon.co/essays/can-philosophy-help-us-get-a-grip-on-the-consequences-of-ai)].
...
[^14]: NHS England, _Federated Data Platform_ [[link](https://www.england.nhs.uk/digitaltechnology/digitising-connecting-and-transforming-health-and-care/)].
[^15]: Salomé Viljoen, _A Relational Theory of Data Governance_ (2021) [[link](https://www.yalelawjournal.org/feature/a-relational-theory-of-data-governance)].
...
[^18]: Salomé Viljoen, _A Relational Theory of Data Governance_ (2021) [[link](https://www.yalelawjournal.org/feature/a-relational-theory-of-data-governance)].
...
[^22]: Andrew Trask, _Introducing OpenMined Research_ (2020) [[link](https://blog.openmined.org/introducing-openmined-research/)].
...
[^25]: Computerworld, _Spain Will Create Foundational AI Model in Local Languages_ (2024) [[link](https://www.computerworld.com/article/3713243/spain-will-create-foundational-ai-model-in-local-languages.html)].
...
[^30]: See Alasdair Milne, _Turret Theory: Training the human with dmsfctn’s Godmode Epochs_ (2023) [[link](https://www.serpentinegalleries.org/arts-technologies/turret-theory/)].
[^31]: Santosh Janardhan, _Reimagining Our Infrastructure for the AI Age_ (2023) [[link](https://www.reuters.com/technology/meta-deploy-in-house-custom-chips-this-year-power-ai-drive-memo-2024-02-01/)]
...
[^37]: See Centre for the Study of Existential Risk, _Risks from Artificial Intelligence_ [[link](https://www.cser.ac.uk/research/risks-from-artificial-intelligence/)].
[^38]: See Centre for Effective Altruism, _History_ [[link](https://www.centreforeffectivealtruism.org/history)].
...
[^42]: Stephen Nellis and Max A. Cherney, _US Curbs AI Chip Exports from Nvidia and AMD to Some Middle East Countries_ (2023) [[link](https://www.reuters.com/technology/us-restricts-exports-some-nvidia-chips-middle-east-countries-filing-2023-08-30/)].
...
[^44]: See _Unprecedented £225m investment to create UK's most powerful supercomputer in Bristol_ (2023) [[link](https://www.bristol.ac.uk/news/2023/november/supercomputer-announcement.html)].
...
[^48]: Daniel Chávez Heras, _The Digital Pastoral: a Minor Critique of Minor Tech_ (2023) [[link](https://darc.au.dk/publications/peer-reviewed-newspaper)].
