...
Applications in the context of this AI stack are software products that utilise machine learning models as a core part of their capability; for example, content creation services such as Stable Diffusion, ChatGPT, or Suno.ai. Other present-day applications include virtual assistants (e.g. Apple’s Siri), recommendation systems (e.g. those used by Netflix), developer tools for writing code (eg. GitHub’s CoPilot), speech and language recognition tools (e.g. Google Translate), biometric identification technology (e.g. fingerprint recognition AppLock), computer sensing and simulation systems (e.g. as those operated by driverless vehicles like CARLA), search engines (e.g. Google Search and Bing), and others.
...
[^40]: Significant increases in computational power since 2016, thanks to advancements by Nvidia, AMD, Intel, and Qualcomm, have enabled the training of larger and more complex AI systems [[link](https://www.bbc.co.uk/news/business-65675027)](https://developer.nvidia.com/about-cuda).
